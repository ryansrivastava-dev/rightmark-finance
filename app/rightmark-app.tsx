...
function Landing({ onAnalyze, onDemo }: { onAnalyze: () => void; onDemo: () => void }) {
  return <main><section className="hero"><div className="heroAtmosphere" aria-hidden="true"><i /><i /><i /></div><div className="heroCopy"><div className="heroKicker"><span className="eyebrow">ALTERNATIVE ASSET INTELLIGENCE</span><small>01 — 06</small></div><h1>The operating system for <em>alternative collateral.</em></h1><p>RightMark turns fragmented public records into an auditable capital view—combining live government data, transparent valuation logic, and institutional-grade stress testing.</p><div className="heroActions"><Button onClick={onAnalyze}>Analyze a public record <b>↗</b></Button><Button variant="dark" onClick={onDemo}>Explore the live model <span>⌘</span></Button></div><div className="trustRow"><span><b>01</b> NOAA holder data</span><span><b>02</b> IPHC + EIA inputs</span><span><b>03</b> Sourced, auditable outputs</span></div></div><div className="heroModel"><div className="modelCaption"><span>RIGHTMARK / COLLATERAL VIEW</span><span>REFRESHED LIVE</span></div><div className="terminalCard"><div className="terminalTop"><span><i /> PUBLIC RECORD MATCH</span><small>NMFS 43983 / AK</small></div><div className="terminalValue"><small>MODELED COLLATERAL VALUE</small><strong>$142,600</strong><span>↗ 83% downside retention</span></div><div className="terminalGrid"><div><small>RISK SIGNAL</small><b>86 <i>/ 100</i></b></div><div><small>MODELED CAPACITY</small><b>$71.3K</b></div></div><div className="sparkBars" aria-label="Illustrative twelve-period value trend">{[34, 44, 39, 56, 51, 68, 61, 75, 72, 86, 82, 94].map((h, i) => <i key={i} style={{ height: `${h}%`, animationDelay: `${i * 55}ms` }} />)}</div><p><b>Pacific Halibut QS</b><span>Public data / modeled output</span></p></div><div className="modelFoot"><span>DATA COVERAGE <b>03 SOURCES</b></span><span>MODEL STATUS <b>ACTIVE</b></span></div></div></section>
