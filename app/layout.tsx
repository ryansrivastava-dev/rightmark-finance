...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const description = "Search every current Alaska IFQ NMFS ID with complete halibut and sablefish records, NOAA conversion ratios, public market data, and transparent valuation models.";
  return {
